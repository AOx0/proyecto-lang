...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    KW_ELSE = 286,                 /* KW_ELSE  */
    KW_DOTS = 287,                 /* KW_DOTS  */
    RELOP_EQ = 288,                /* RELOP_EQ  */
    RELOP_NEQ = 289,               /* RELOP_NEQ  */
    RELOP_BT = 290,                /* RELOP_BT  */
    RELOP_LT = 291,                /* RELOP_LT  */
    RELOP_EBT = 292,               /* RELOP_EBT  */
    RELOP_ELT = 293,               /* RELOP_ELT  */
    RELOP_AND = 294,               /* RELOP_AND  */
    RELOP_NOT = 295,               /* RELOP_NOT  */
    RELOP_OR = 296,                /* RELOP_OR  */
    T_INT = 297,                   /* T_INT  */
    T_REAL = 298,                  /* T_REAL  */
    T_STR = 299,                   /* T_STR  */
    T_BOOL = 300                   /* T_BOOL  */
