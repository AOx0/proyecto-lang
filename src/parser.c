...
{
       0,   139,   139,   139,   153,   159,   167,   167,   167,   169,
     179,   182,   185,   190,   190,   191,   191,   191,   191,   194,
     194,   195,   196,   196,   203,   203,   212,   219,   220,   223,
     231,   232,   232,   233,   233,   234,   234,   234,   235,   235,
     235,   235,   237,   238,   239,   241,   245,   249,   249,   253,
     253,   254,   254,   255,   255,   261,   265,   269,   273,   277,
     278,   281,   282,   282,   283,   283,   287,   287,   290,   290,
     291,   291,   292,   292,   293,   293,   294,   295,   295,   298,
     298,   299,   299,   300,   300,   301,   302,   302,   302,   302,
     302,   302,   302
};
#endif
...
yyreduce:
  ...
  case 9:
    ...
    for (size_t i=0; i < (yyvsp[(3) - (6)].idents).len; i++) {
        Symbol s = (Symbol) { .name = *(StrSlice *)vec_get(&(yyvsp[(3) - (6)].idents), i), .scope = scope, .line = linea };
  ...
  case 23:
    ...
    {
    scope--;
    printf("Declarada %.*s\n", (int)(yyvsp[(2) - (7)].slice).len, (yyvsp[(2) - (7)].slice).ptr);
}
    break;
  ...
  case 26:
    ...
    for (size_t i=0; i < (yyvsp[(2) - (3)].idents).len; i++) {
        Symbol s = (Symbol) { .name = *(StrSlice *)vec_get(&(yyvsp[(2) - (3)].idents), i), .scope = scope, .line = linea };
        assert_not_sym_exists(&s);
        hashset_insert(&tabla, &s);
    }
}
  ...
  case 45:
    ...
    {
    Symbol s = (Symbol) { .name = (yyvsp[(3) - (4)].slice), .scope = scope, .line = linea };
    assert_sym_exists(&s);
}
    break;
  ...
  case 48:
    ...
    {
    Symbol s = (Symbol) { .name = (yyvsp[(5) - (6)].slice), .scope = scope, .line = linea };
    assert_sym_exists(&s);
}
    break;
  ...
  case 54:
    ...
    {
    Symbol s = (Symbol) { .name = (yyvsp[(3) - (6)].slice), .scope = scope, .line = linea };
    Symbol s1 = (Symbol) { .name = (yyvsp[(5) - (6)].slice), .scope = scope, .line = linea };
    assert_sym_exists(&s);
  ...
  case 55:
    ...
    {
    Symbol s = (Symbol) { .name = (yyvsp[(3) - (4)].slice), .line = linea };
    assert_sym_exists(&s);
}
    break;
  ...
  case 57:
    ...
    {
    Symbol s = (Symbol) { .name = (yyvsp[(3) - (6)].slice), .line = linea };
    assert_sym_exists(&s);
}
    break;
  ...
  case 65:
    ...
    {
    Symbol s = (Symbol) { .name = (yyvsp[(1) - (4)].slice), .line = linea };
    assert_sym_exists(&s);
}
    break;
