...
{
       0,   180,   180,   180,   252,   257,   264,   264,   264,   266,
     279,   287,   295,   305,   306,   310,   311,   312,   313,   316,
     316,   318,   321,   321,   332,   332,   345,   358,   359,   369,
     385,   386,   386,   387,   387,   389,   390,   390,   390,   391,
     391,   391,   393,   394,   395,   396,   397,   398,   401,   404,
     405,   406,   407,   408,   412,   416,   417,   418,   421,   425,
     426,   429,   430,   430,   431,   432,   433,   434,   439,   439,
     440,   440,   441,   441,   442,   442,   443,   444,   444,   444,
     444,   444,   444,   445,   445,   448,   448,   449,   449,   450,
     450,   451,   452,   453,   454,   454,   454,   454,   455
};
#endif
...
yyreduce:
  ...
  case 3:
    ...
    node->value.fun = (FunctionNode) { .name = (yyvsp[(3) - (11)].symbol).name, .args = (yyvsp[(5) - (11)].idents) };
  ...
  case 10:
    ...
    (yyvsp[(3) - (6)].symbol).info.cons = (ConstantInfo){.type = (DataType){.type = Int, .size = 4},
                                  .addr = addr};
    addr += 4;
  ...
  case 11:
    ...
    {
    (yyvsp[(3) - (6)].symbol).type = Constant;
    (yyvsp[(3) - (6)].symbol).info.cons = (ConstantInfo){.type = (DataType){.type = Real, .size = 4},
                                  .addr = addr};
    addr += 4;
    assert_not_sym_exists(&(yyvsp[(3) - (6)].symbol));
    hashset_insert(&tabla, &(yyvsp[(3) - (6)].symbol));
  ...
  case 12:
    ...
    (yyvsp[(3) - (6)].symbol).info.cons = (ConstantInfo){
        .type = (DataType){.type = Str, .size = (yyvsp[(5) - (6)].slice).len}, .addr = addr};
