...
{
       0,   130,   130,   130,   144,   150,   158,   158,   158,   160,
     170,   173,   176,   181,   181,   182,   182,   182,   182,   185,
     185,   186,   187,   187,   189,   189,   196,   202,   203,   206,
     214,   215,   215,   216,   216,   217,   217,   217,   218,   218,
     218,   218,   220,   221,   222,   224,   224,   228,   228,   232,
     232,   233,   233,   234,   234,   240,   240,   241,   241,   245,
     246,   249,   250,   250,   251,   251,   255,   255,   258,   258,
     259,   259,   260,   260,   261,   261,   262,   263,   263,   266,
...
yyreduce:
  ...
  case 9:
    ...
    for (size_t i=0; i < (yyvsp[(3) - (6)].idents).len; i++) {
        Symbol s = (Symbol) { .name = *(StrSlice *)vec_get(&(yyvsp[(3) - (6)].idents), i), .scope = 0, .line = 0 };
  ...
  case 46:
    ...
    { 
    Symbol s = (Symbol) { .name = (yyvsp[(3) - (4)].slice), .scope = 0, .line = 0 };
    assert_sym_exists(&s);
}
    break;
  ...
  case 48:
    ...
    {
    Symbol s = (Symbol) { .name = (yyvsp[(5) - (6)].slice), .scope = 0, .line = 0 };
    assert_sym_exists(&s);
}
    break;
  ...
  case 54:
    ...
    {
    Symbol s = (Symbol) { .name = (yyvsp[(3) - (6)].slice), .scope = 0, .line = 0 };
    Symbol s1 = (Symbol) { .name = (yyvsp[(5) - (6)].slice), .scope = 0, .line = 0 };
    assert_sym_exists(&s);
