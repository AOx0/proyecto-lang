...
static const yytype_uint16 yyrline[] = {
    0,    294,  294,  294,  412,  417,  424,  424,  424,  426,  441,  458,
    475,  495,  496,  500,  501,  502,  503,  506,  509,  517,  533,  533,
    546,  546,  561,  574,  577,  588,  605,  608,  619,  626,  631,  638,
    639,  639,  639,  640,  640,  640,  643,  654,  666,  681,  693,  707,
    735,  764,  780,  796,  815,  835,  869,  904,  927,  951,  975,  999,
    1012, 1030, 1045, 1045, 1047, 1060, 1089, 1120, 1181, 1198, 1200, 1217,
    1219, 1233, 1235, 1235, 1237, 1253, 1254, 1255, 1256, 1257, 1258, 1259,
    1260, 1263, 1272, 1275, 1278, 1278, 1296, 1296, 1314, 1375, 1388, 1416,
    1434, 1445, 1456, 1471};
#endif
...
#define yypact_value_is_default(Yystate) (!!((Yystate) == (-153)))
...
#line 300 "src/grammar.y"
    {
        ...
        if (err == 0)
            node_display_id(0, OUT_FILE, &ast, &tabla);
...
#line 707 "src/grammar.y"
    {
        ...
        str->asoc_type = Str;
        str->value.cons = (ConstNode){.symbol = (yyvsp[(3) - (6)].slice),
...
#line 764 "src/grammar.y"
    {
        ...
        str->node_type = NConst;
        str->asoc_type = Str;
        str->value.cons = (ConstNode){.symbol = (yyvsp[(3) - (4)].slice),
...
#line 796 "src/grammar.y"
    {
        ...
        tree_new_relation(&(yyval.subtree), 0, 1);
        tree_extend_with_subtree(&(yyval.subtree), &(yyvsp[(5) - (6)].subtree),
                                 0, 0);
    } break;
...
#line 1263 "src/grammar.y"
    {
        ...
        *void_root = (Node){.node_type = NVoid};
