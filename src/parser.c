...
static const yytype_uint16 yyrline[] = {
    0,   177, 177, 177, 196, 201, 208, 208, 208, 210, 222, 228, 234, 242, 243,
    247, 248, 249, 250, 253, 253, 254, 257, 257, 267, 267, 276, 287, 288, 297,
    313, 314, 314, 315, 315, 316, 316, 316, 317, 317, 317, 317, 319, 320, 321,
    323, 326, 329, 332, 335, 335, 336, 336, 337, 341, 345, 348, 351, 354, 357,
    358, 361, 362, 362, 363, 366, 369, 372, 377, 377, 378, 378, 379, 379, 380,
    380, 381, 382, 382, 382, 382, 382, 382, 382, 382, 385, 385, 386, 386, 387,
    387, 388, 391, 394, 397, 397, 397, 397, 397};
#endif
...
yyreduce:
...

    {
        ...
        (yyvsp[(3) - (6)].symbol).info.cons = (ConstantInfo){
            .type = (DataType){.type = Int, .size = 4}, .addr = 0};
...

    {
        (yyvsp[(3) - (6)].symbol).type = Constant;
        (yyvsp[(3) - (6)].symbol).info.cons = (ConstantInfo){
            .type = (DataType){.type = Real, .size = 4}, .addr = 0};
        assert_not_sym_exists(&(yyvsp[(3) - (6)].symbol));
        hashset_insert(&tabla, &(yyvsp[(3) - (6)].symbol));
        ;
    } break;
...

    {
        (yyvsp[(3) - (6)].symbol).type = Constant;
        (yyvsp[(3) - (6)].symbol).info.cons = (ConstantInfo){
            .type = (DataType){.type = Str, .size = 1}, .addr = 0};
        assert_not_sym_exists(&(yyvsp[(3) - (6)].symbol));
        hashset_insert(&tabla, &(yyvsp[(3) - (6)].symbol));
        ;
    } break;
