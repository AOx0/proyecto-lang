...
static const yytype_uint16 yyrline[] = {
    0,   179, 179, 179, 258, 263, 270, 270, 270, 272, 285, 293, 301, 311, 312,
    316, 317, 318, 319, 322, 322, 324, 327, 327, 338, 338, 348, 360, 361, 371,
...
#define yypact_value_is_default(Yystate) (!!((Yystate) == (-158)))
...
yyreduce:
...

    {
        ...
        (yyvsp[(3) - (6)].symbol).info.cons = (ConstantInfo){
            .type = (DataType){.type = Int, .size = 4}, .addr = addr};
        addr += 4;
...

    {
        (yyvsp[(3) - (6)].symbol).type = Constant;
        (yyvsp[(3) - (6)].symbol).info.cons = (ConstantInfo){
            .type = (DataType){.type = Real, .size = 4}, .addr = addr};
        addr += 4;
        assert_not_sym_exists(&(yyvsp[(3) - (6)].symbol));
        hashset_insert(&tabla, &(yyvsp[(3) - (6)].symbol));
    } break;
